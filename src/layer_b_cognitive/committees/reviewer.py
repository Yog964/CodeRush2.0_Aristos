...
class ReviewerAgent:
    """Reviewer persona. Reviews code quality and logic."""
    def __init__(self, llm_adapter):
        self.llm_adapter = llm_adapter
        self.system_prompt = "You are the Reviewer. Review code quality and logic. Use read_file, run_command actions only."
    ...
    def execute(self, task: TaskNode, context: str) -> list:
        ...
        output_log = [f"Starting task execution for persona: Reviewer"]
