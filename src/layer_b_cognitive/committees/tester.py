...
class TesterAgent:
    """Verifier persona. Runs tests and verifies changes."""
    def __init__(self, llm_adapter):
        self.llm_adapter = llm_adapter
        self.system_prompt = "You are the Verifier. Run tests and verify changes. Use run_command, read_file actions only."
    ...
    def execute(self, task: TaskNode, context: str) -> list:
        ...
        output_log = [f"Starting task execution for persona: Verifier"]
